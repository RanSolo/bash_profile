...
alias b="cd .."
alias c="clear"
alias qf="cd ~/Documents/code/ppl-quickfill"
alias lui="cd ~/Documents/Code/leo-ui/ui-react"
alias arch="cd ~/Documents/Code/archive"
alias data="cd ~/Documents/Data"
alias dcu="docker-compose up"
alias dcd="docker-compose up"
alias dcb="docker-compose build"
alias de="docker exec -it"
alias drj="docker run -p 8080:8080 -p 50000:50000 -v /var/jenkins_home -d --name jenkins jenkins"
alias dps="docker ps"
alias  gbd="gck development"
alias  gmd="gmd git merge development"
alias gc="git commit"

alias mgd='brew services start mongodb-community'
alias gck="git co"
alias gck="git co"
...
alias cw="atom --clear-window-state"
alias apps="open /Applications/"
alias pgs="open /Applications/Pages.app/"
alias chr="open /Applications/Google\ Chrome.app/"

alias now="date +"%T %m-%d-%Y""
alias data="cd ~/Documents/Data"
alias ebp="vi ~/.zprofile"
alias h="history"
alias paths="echo -e ${PATH//:/\\n}"
alias rlbp="source ~/.zprofile"
alias ga="git add"
alias ek="cd ~/Documents/Code/eastkin"
...
alias 3000="open http://localhost:3000/ && rails s"
